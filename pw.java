...
class HelloWorld
{
    public static void main(String[] args) 
    {
        ...
        for(int i=0; i<n; i++)
      {
            ...
            {
                if(j==0 || j==n-1 || i+j==8 && j<=4 || i-j==0 && j>=4   )
                {
                    System.out.print("* ");
            ...
            {
                if( i==0 && j<(n-1)/2 && j>0  || j==0 && i<(n-1)/2 && i>0 && i<(n-1)/2 || i==(n-1)/2 && j<(n-1)/2 && j>0 || j==(n-1)/2 &&
                 i>(n-1)/2 && i<(n-1) || i==(n-1 ) && j<(n-1)/2 && j>0  )
                {
                    System.out.print("* ");
            ...
            for(int i=0; i<n; i++)
          {
             ...
             {
                if( j==(n-1)/2 && i>=3 || j-i==1 && i<=3 || i+j==7 && i<=3   )
                {
                    System.out.print("* ");
            ...
            {
                if(j==0 || j==n-1 || i+j==8 && i>=4 || i-j==0 && i>=4     )
                {
                    System.out.print("* ");
